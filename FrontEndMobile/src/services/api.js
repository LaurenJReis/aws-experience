...
export const cadastroPF = (data) => {
  ...
  return publicApi.post('/api/pessoaFisica', data);
};
export const createPessoaFisica = (data) => api.post('/api/pessoaFisica', data);
...
export const getPessoasJuridicas = () => api.get('/api/pessoa-juridica');
export const getPessoaJuridica = (id) => api.get(`/api/pessoa-juridica/${id}`);
export const cadastroPJ = (data) => {
  ...
  return publicApi.post('/api/pessoa-juridica', data);
};
export const createPessoaJuridica = (data) => api.post('/api/pessoa-juridica', data);
export const updatePessoaJuridica = (id, data) => api.put(`/api/pessoa-juridica/${id}`, data);
export const deletePessoaJuridica = (id) => api.delete(`/api/pessoa-juridica/${id}`);
...
export const createStatusFabricacao = (veiculoId, status) =>
  api.post(`/api/veiculo/${veiculoId}/status`, JSON.stringify(status), {
    headers: { 'Content-Type': 'application/json' },
  });
