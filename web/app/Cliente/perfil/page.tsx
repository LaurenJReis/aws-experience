...
export default function Perfil() {
  ...
  useEffect(() => {
    ...
    api.get("/api/usuario/me")
      ...
      .catch(() => {
        // Não redireciona — mostra o email salvo localmente
        const emailSalvo = localStorage.getItem("user");
        if (emailSalvo) {
          setUsuario({ id: 0, nome: "", email: emailSalvo, dataNascimento: "", role: "CLIENTE", ativo: true });
        }
