...
public class TelefoneController {
    ...
    @GetMapping
    public ResponseEntity<Page<TelefoneResponse>> getAllTelefones(Pageable pageable) {
        return ResponseEntity.ok(telefoneService.findAll(pageable).map(TelefoneMapper::toResponse));
    }
