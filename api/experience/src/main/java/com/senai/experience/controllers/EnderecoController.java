...
public class EnderecoController {
    ...
    @GetMapping
    public ResponseEntity<Page<EnderecoResponse>> getAllEnderecos(Pageable pageable) {
        return ResponseEntity.ok(enderecoService.findAll(pageable).map(EnderecoMapper::toResponse));
    }
