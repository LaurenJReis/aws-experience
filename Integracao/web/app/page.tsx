...
export default function Home() {
  ...
  const newsList: News[] = [
    ...
    },
    {
      ...
      summary: "Programa completa 12 meses unindo formação técnica e prática industrial.",
      content: "O TechMob 4.0 vai além de um curso convencional: ele prepara os jovens para os desafios da Indústria 4.0, com foco em inovação, empregabilidade e desenvolvimento de soluções tecnológicas que atendam às necessidades do mercado atual.",
    },
    {
      image: ["/10anos.jpeg"],
      ...
      content: "Todo veículo zero km da marca já sai de fábrica com 5 anos de garantia. Após esse período, o cliente pode estender a cobertura por mais 5 anos adicionais, totalizando até 10 anos de proteção.",
    },
    {
      image: ["/novaFa.jpeg"],
      ...
      content: "A Toyota confirmou a construção de uma nova fábrica no Brasil, como parte de um plano de investimentos de R$ 11 bilhões até 2030 para expandir a produção e fortalecer a presença no país.",
    },
    {
      image: ["/Carro-dos-Sonhos.jpg"],
      title: "Toyota abre inscrições para o concurso Carro dos Sonhos 2026",
      summary: "Iniciativa estimula a criatividade de crianças e adolescentes por meio de desenhos.",
      content: "O concurso convida jovens de 6 a 16 anos a desenharem o carro dos seus sonhos, incentivando criatividade e interesse pela indústria automotiva.",
    },
    {
      image: ["/ararinha.jpeg"],
      title: "Fundação Toyota destaca o Projeto Arara Azul",
      summary: "Projeto protege a arara-azul e fortalece o equilíbrio do Pantanal.",
      content: "Idealizado pela bióloga Neiva Guedes em 1989, o projeto promove a conservação da arara-azul e da biodiversidade do Pantanal com apoio da Toyota.",
    },
  ];
